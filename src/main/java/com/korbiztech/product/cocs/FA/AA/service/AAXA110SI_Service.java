...
import com.korbiztech.product.cocs.FA.AA.dao.AAXA110SI_DAO;
...
@Service
@Transactional
public class AAXA110SI_Service {
	...
	public List<HashMap<String, ?>> modal_01Info(paramVO searchCondition){
        ...
        return dao.modal_01Info(searchCondition);
    }
    ...
    public ResponseEntity<?> saveGridData(HttpServletRequest request, String gridName) {
		...
		if (errorResponse != null) {
			...
			List<AAXA110SI_VO> updateList = new ArrayList<>();
			List<AAXA110SI_VO> insertList = new ArrayList<>();
			List<AAXA110SI_VO> deleteList = new ArrayList<>();
			for (SaveGridDataVO item : voList) {
				Object data = item.getData();
				Gson gson = new Gson();
				String jsonData = gson.toJson(data);
				AAXA110SI_VO vo = gson.fromJson(jsonData, AAXA110SI_VO.class);
