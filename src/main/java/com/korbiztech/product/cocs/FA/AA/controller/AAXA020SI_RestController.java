...
import com.korbiztech.product.cocs.FA.AA.service.AAXA020SI_Service;
import com.korbiztech.product.cocs.FA.AA.vo.paramVO;

import jakarta.servlet.http.HttpServletRequest;

@RestController
@RequestMapping("/api/AAXA020SI/")
public class AAXA020SI_RestController {     
    
    @Autowired
    AAXA020SI_Service service;
