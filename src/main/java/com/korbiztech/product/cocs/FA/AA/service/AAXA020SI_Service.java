...
import com.korbiztech.product.cocs.FA.AA.dao.AAXA020SI_DAO;
...
@Service
@Transactional
public class AAXA020SI_Service {
...
//    }
    ...
    public ResponseEntity<?> saveGridData(HttpServletRequest request, String gridName) {
		...
		if (errorResponse != null) {
			...
			List<AAXA020SI_VO> updateList = new ArrayList<>();
			List<AAXA020SI_VO> insertList = new ArrayList<>();
			List<AAXA020SI_VO> deleteList = new ArrayList<>();
			for (SaveGridDataVO item : voList) {
				Object data = item.getData();
				Gson gson = new Gson();
				String jsonData = gson.toJson(data);
				AAXA020SI_VO vo = gson.fromJson(jsonData, AAXA020SI_VO.class);
